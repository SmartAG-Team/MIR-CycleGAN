...
def predict(config, args):
    ...
    with torch.no_grad():
        for i, batch in enumerate(tqdm(data_loader)):
            ...
            save_image(args.out_dir, allim[0:256, 0:512], i, 1, filename=filename)
            # save_image(args.out_dir, allim[0:512, 0:1024], i, 1, filename=filename)
            # save_image(args.out_dir, allim[0:512, 512:1024], i, 1, filename=filename)
