...
def psnr_ssim_cal(cloudfree, predict):
    psnr1 = psnr(cloudfree, predict)
    ssim1 = ssim(cloudfree, predict, multichannel=True,
                        gaussian_weights=True, use_sample_covariance=False, sigma=1.5, win_size=3)
    return psnr1, ssim1
...
def PSNR_SSIM(cloudless, predict, save_path):
    ...
    psnr1, ssim1 = psnr_ssim_cal(cloudless_rgb, predict_rgb)
