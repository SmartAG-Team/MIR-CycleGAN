...
if __name__ == "__main__":
    ...
    """Path"""
    parser.add_argument("--load_gen", type=str, default='./pretrained\pmaa_old.pth',
                        help="which checkpoint you want to use for generator")
    parser.add_argument("--predict_image_path", type=str,
                        default=r'C:\Users\lenovo\Desktop\real_exm\PMAA\results', help="name of the dataset_list")
    parser.add_argument("--root", type=str, default=r'C:\Users\lenovo\Desktop\real_exm\PMAA',
    ...
    total_data = MultipleDataset(
        root=os.path.join(opt.root, "dataset"),
        band=opt.in_channel,
    )
