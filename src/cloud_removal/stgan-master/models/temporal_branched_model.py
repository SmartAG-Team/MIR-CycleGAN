...
class TemporalBranchedModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A_0', 'real_A_1', 'fake_B', 'real_B']
    ...
    def set_input(self, input):
        ...
        options = [self.real_A_0.clone(), self.real_A_1.clone()]
        scramble = random.sample(range(0, 2), 2)
        if self.opt.scramble == True:
            self.real_A_0 = options[scramble[0]]
            self.real_A_1 = options[scramble[1]]
        self.real_A = torch.cat((self.real_A_0, self.real_A_1), 1).to(self.device)
