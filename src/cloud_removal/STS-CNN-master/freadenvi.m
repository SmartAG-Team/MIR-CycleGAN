function [image,p,t,c]=freadenvi(fname)
...
% OUTPUT :
%
% image	c*l by b array containing the ENVI image values organised in
...
elements={'samples ' 'lines   ' 'bands   ' 'data type ' 'classes '};
