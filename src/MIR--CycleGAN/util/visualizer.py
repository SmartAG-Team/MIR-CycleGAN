...
def save_images(webpage, visuals, image_path, aspect_ratio=1.0, width=256, use_wandb=False):
    ...
    for label, im_data in visuals.items():
        if label == 'fake_B' or label == 'real_A_miss' or label == 'real_A_ref' or label == 'real_B':
...
class Visualizer():
    ...
    def print_current_losses(self, epoch, iters, losses, t_comp, t_data):
        ...
        return (round(GA_loss, 3), round(CycleA_loss, 3), round(IdtA_loss, 3), round(GB_loss, 3), round(CycleB_loss, 3), round(IdtB_loss, 3), round(Lc_loss, 3))
        # return (round(GA_loss, 3), round(CycleA_loss, 3), round(IdtA_loss, 3), round(GB_loss, 3), round(CycleB_loss, 3), round(IdtB_loss, 3))
