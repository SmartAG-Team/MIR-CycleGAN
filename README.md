...
### MIR-CycleGAN train/test
- Download a MIR-CycleGAN dataset ():
- train the model :
```bash
python train.py --dataroot ./datasets/MIR-CycleGAN --name mir_cyclegan --model multi_cycle_gan --dataset_mode missdata --netG multi_unet --input_nc 3 --output_nc 3
```

- Test the model :
```bash
python test.py --dataroot ./datasets/MIR-CycleGAN/cloudthin --name mir_cyclegan --model multi_cycle_gan --dataset_mode missdata --netG multi_unet --checkpoints_dir ./root/autodl-tmp/checkpoints --input_nc 3 --output_nc 3 --epoch latest --results_dir ./root/autodl-tmp/results/ceshi
```
